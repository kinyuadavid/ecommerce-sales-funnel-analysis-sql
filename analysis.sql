...
-- Sales funnel and different stages (Total number of customers going through different stages of the sales process)
...
SELECT stage_1_pg_view,
      ...
      ROUND (stage_5_purchase*100/stage_1_pg_view) AS overall_conversion_rate

FROM sales_funnel

          -- We dont have any technical issues when customers are making payments (92.0 % payment to purchase rate)
          -- Very many People are viewing product but few proceed to cart (31.0 % view_to_cart_rate); 
             Recomedation: UI can be improved for people to see products easily 
...
FROM conversion_journey
          ...
          -- it takes average of 24.55 minutes for a customer to complete the journey and make a purchase
